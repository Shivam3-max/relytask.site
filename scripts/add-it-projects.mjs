...
const PROJECTS = [
  {
    ...
    metrics: [],
    seed: 1,
    imageUrl: "/uploads/068527a6-5a8d-449a-8779-ac407e0e7bd3.png",
    order: 0,
    confidential: false,
    featured: true,
    published: true,
  },
  {
    ...
    metrics: [],
    seed: 2,
    imageUrl: "/uploads/d32649b2-634b-4517-a794-64913bb8ebc6.png",
    order: 1,
    confidential: false,
    featured: false,
    published: true,
  },
  {
    ...
    metrics: [],
    seed: 3,
    imageUrl: "/uploads/05adc78d-ea55-4c79-b6c6-a459eefc19d6.png",
    order: 2,
    confidential: false,
    featured: false,
    published: true,
  },
  {
    ...
    metrics: [],
    seed: 4,
    imageUrl: "/uploads/ad79d577-4484-450e-90d3-a995746a1699.png",
    order: 3,
    confidential: false,
    featured: false,
    published: true,
  },
  {
    ...
    metrics: [],
    seed: 5,
    imageUrl: "/uploads/67602863-32e7-4a9a-a939-2e4f2c32d2c8.png",
    order: 4,
    confidential: false,
    featured: false,
    published: true,
  },
  {
    ...
    metrics: [],
    seed: 6,
    imageUrl: "/uploads/3b3354f3-3fb6-49f8-a25d-31c107afda32.png",
    order: 5,
    confidential: false,
    featured: false,
    published: true,
  },
  {
    slug: "paarth",
    client: "Paarth",
    title: "A capability system for a members-only builder community",
    category: "Technology",
    industry: "Professional community platform",
    year: "2026",
    timeline: "",
    liveUrl: "https://joinpaarth.com",
    summary:
      "The landing site for Paarth, \"the space for builders, marketers and business leaders\" — a dark, boot-sequence-styled entry point ahead of full launch.",
    challenge:
      "Pre-launch community sites usually default to a generic waitlist form; Paarth needed a first impression that already felt like the kind of product a builder, marketer or exec would want to be early to.",
    services: ["Web design", "Development"],
    stack: ["Next.js", "Tailwind CSS", "Vercel"],
    approach: [
      { title: "Design the wait, not just the form", body: "A terminal-style boot sequence — \"initializing capability system,\" \"loading frameworks,\" \"marketing / AI / leadership — online\" — makes the pre-launch moment itself feel like part of the product." },
      { title: "Say who it's for, once, clearly", body: "\"The space for builders, marketers & business leaders\" is the entire pitch, kept deliberately uncluttered rather than padded with feature promises." },
    ],
    metrics: [],
    seed: 7,
    imageUrl: "/uploads/f345417f-3450-4faa-86ef-b4368d0caa1b.png",
    order: 6,
    confidential: false,
    featured: false,
    published: true,
  },
  {
    ...
    metrics: [],
    seed: 8,
    imageUrl: "/uploads/30655998-1316-43f2-b4b3-4f10638e5ffa.png",
    order: 7,
    confidential: false,
    featured: false,
    published: true,
  },
  {
    ...
    metrics: [],
    seed: 9,
    imageUrl: "/uploads/448b0c98-09f9-4d37-8242-ba47b60eadcc.png",
    order: 8,
    confidential: false,
    featured: false,
    published: true,
  },
  {
    ...
    metrics: [],
    seed: 10,
    imageUrl: "/uploads/dc825471-b60c-4d34-888c-6b34d1328b58.png",
    order: 9,
    confidential: false,
    featured: false,
    published: true,
