...
export default function WhatsAppFloat() {
  return (
    <a
      ...
      aria-label="Chat with RelyTask on WhatsApp"
      className="fixed bottom-5 right-5 z-50 flex h-13 w-13 items-center justify-center rounded-full text-paper shadow-[0_10px_30px_-8px_rgba(20,24,43,0.5)] transition-transform duration-300 hover:scale-105 md:bottom-7 md:right-7"
      style={{ height: 52, width: 52, background: "#25D366" }}
    >
